                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<button class='btn btn-info btn-sm editBtn' data-toggle='modal' data-target='#editPengurusModal' data-id='" . $row['id'] . "' data-nama='" . $row['nama'] . "''><i class='fas fa-edit'></i> Edit</button>";
